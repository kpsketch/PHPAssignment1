...
<main>
    ...
    <form action="update_item.php" method="post" id="update_item_form">
        ...
        <div id="data">
            ...
            <input type="radio" name="status" value="To Buy"
                <?php if ($item['status'] == 'To Buy') echo 'checked'; ?> />
                To Buy<br />

            <input type="radio" name="status" value="Bought"
                <?php if ($item['status'] == 'Bought') echo 'checked'; ?> />
                Bought<br /><br />
